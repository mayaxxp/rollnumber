	...
	<div :class="{'dataview_popwindow':true,'show_popwindow':dataShow}">
		...
		<div  class="popwindow_content">
			<div :id="dataInfo.id" ref="popWin_ccl" class="Hmn_panel_content" :style="positionInfo">
				...
				<div class="Hmn_panelAC_mid" :style="{height : parseInt(dataInfo.height)-140 +'px'}">
					<div class="Hmn_panelAC_Mid_left"></div>
					<div class="Hmn_panelAC_Mid_center" :style="{width : parseInt(dataInfo.width)-120+75 +'px'}">
				...
				<div class="Hmn_panelAC_Content" :style="{width : parseInt(dataInfo.width)-75 +'px',height : parseInt(dataInfo.height)- 67 +'px'}">
  	...
  	computed: { 
	    ...
	    ,positionInfo(){ 
	    	...
	    	obj={
	    		...
	    		,'height':(parseInt(this.dataInfo.height))+'px'
